...
const translations = {
    fr: {
        ...
        title_evangelism: "CCMG Évangélisation",
...
L’équipe d’évangélisation - Église {nom_eglise}`,
    ...
    en: {
        welcome: "Welcome",
        subtitle_evangelism: "Union Des Assemblées Maison de Grâce",
        title_evangelism: "CCMG Evangelism",
        ...
        phone_abbr: "Ph",
        relaunch: "FOLLOW-UP",
        msg_level1: "Hello {prenom}, this is {referent} from CCMG. Nice to meet you! Let's stay in touch. See you soon!",
