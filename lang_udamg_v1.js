...
const translations = {
    fr: {
        ...
        phone_abbr: "Tél",
        relaunch: "OPTIONS",
        options_title: "Options du contact",
        transfer_to_church: "Transférer à une église",
        inform_pastor: "Informer le pasteur par email",
        transfer_confirm: "Confirmer le transfert",
        invite_seniors: "Inviter les anciens",
        add_to_seniors: "Ajouter à ancien",
        confirm_move_senior: "Voulez-vous vraiment déplacer ce contact vers la liste des anciens ?",
        seniors_title: "Gestion des Anciens",
        send_bulk_invite: "Envoyer l'invitation groupée",
        bulk_msg_placeholder: "Écrivez ici le message d'invitation...",
        copy_numbers: "Copier tous les numéros",
        transfer_success: "Contact transféré avec succès !",
        msg_transfer_pastor: "Bonjour Pasteur,\n\nJe vous transfère le contact {nom} {prenom} (Tél: {tel}) qui a été évangélisé à {ancienne_eglise}.\n\nDieu vous bénisse !",
...
Équipe d’évangélisation du {nom_eglise}`,
    ...
    en: {
        ...
        transfer_to_church: "Transfer to another church",
        inform_pastor: "Inform pastor by email",
        ...
        copy_numbers: "Copy all numbers",
        transfer_confirm: "Confirm transfer",
        transfer_success: "Contact transferred successfully!",
        msg_transfer_pastor: "Hello Pastor,\n\nI am transferring the contact {nom} {prenom} (Ph: {tel}) to you, who was reached at {ancienne_eglise}.\n\nGod bless you!",
